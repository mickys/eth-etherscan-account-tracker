...
var EthEtherscanAccountTracker = /** @class */ (function () {
    ...
    EthEtherscanAccountTracker.prototype.getAccountTransactions = function (customStartBlock) {
        return __awaiter(this, void 0, void 0, function () {
            var currentBlock, normalTxns, internalTxns;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getBlockNumber()];
                    case 1:
                        currentBlock = _a.sent();
                        return [4 /*yield*/, this.getAccountNormalTransactions(customStartBlock)];
                    case 2:
                        normalTxns = _a.sent();
                        return [4 /*yield*/, this.getAccountInternalTransactions(customStartBlock)];
                    case 3:
    ...
    EthEtherscanAccountTracker.prototype.prepareAccountTransactions = function (normalTxns, internalTxns, block) {
        return __awaiter(this, void 0, void 0, function () {
            var list;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                if (normalTxns !== undefined) {
                    normalTxns.forEach(function (data) {
                        if (_this.validateAndUpdateIncommingTransactionData(data, block)) {
                            list.push(data);
                        }
                    });
                }
                if (internalTxns !== undefined) {
                    internalTxns.forEach(function (data) {
                        if (_this.validateAndUpdateIncommingTransactionData(data, block)) {
                            list.push(data);
                        }
                    });
                }
                list.sort(function (a, b) { return a.blockNumber.localeCompare(b.blockNumber); });
